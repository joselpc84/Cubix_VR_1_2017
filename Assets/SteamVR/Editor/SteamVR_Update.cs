...
// InstantVR: change in method ShouldDisplay()
...
public class SteamVR_Update : EditorWindow
{
	...
	{
        // PS: do not display update dialogs, because updates can break InstantVR
        // this happened for example when going from 1.1.1 to 1.2.0
        // PasserVR will take care of rolling out the update
        return false;
        /*
